    ...
    <section className='Project-container'>
      <article className='event'>
        ...
        <div className='event-detail'>
          ...
          <p className='event-description'>El evento fue organizado por Globant, donde mas de 80 equipos participaron en una hackaron, tuve un equipo formada por 6 chicas en programación.</p>
      ...
      <article className='event'>
        ...
        <div className='event-detail'>
          <h3 className='event-title'>CMDT - Propuesta para registro de consultorio</h3>
